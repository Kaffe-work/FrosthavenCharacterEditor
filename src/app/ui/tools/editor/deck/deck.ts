...
export class DeckEditorComponent implements OnInit {
    ...
    updateExperience(ability: any) {
        // Increment the experience value, wrapping around to 0 if it reaches 9
        ability.experience = (ability.experience + 1) % 10;
        // Call your deckDataToJson() function here if needed
        this.deckDataToJson();
    }
    updateContinuous(ability: any) {
